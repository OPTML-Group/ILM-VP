...
if __name__ == '__main__':
    ...
    exp = f"data_fraction/linear-probing-resnet"
    ...
    loaders, class_names = prepare_gtsrb_fraction_data(data_path=data_path, fraction=args.fraction, preprocess=preprocess)
